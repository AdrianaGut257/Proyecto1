...
\textbf{3. GitHub}
\vspace{-20pt}
\begin{center}\includegraphics[width=3cm]{images/tools/github.png}\end{center} \\ \hline
...
\vspace{-20pt}
\begin{center}\includegraphics[width=3cm]{images/tools/visualStudioCode.png}\end{center} \\ \hline
...
\subsection{Verificación del uso de \LaTeX{} y guía para la descarga del informe en formato PDF}

\subsubsection{Verificación del uso de \LaTeX{}}

La verificación del uso de \LaTeX{} en la elaboración del informe se puede realizar mediante 
la inspección de los archivos disponibles en el repositorio. En particular, 
la presencia de archivos con extensión \texttt{.tex} constituye evidencia directa de que el 
documento fue desarrollado utilizando dicho sistema de composición tipográfica.

\begin{figure}[H]
    \centering
    \captionsetup{width=0.5\textwidth}
    \caption{Verificación del uso de LaTeX}
    \includegraphics[width=0.9\textwidth]{images/latexVerification/verification1.jpg}
    \caption*{Nota: Captura de pantalla del repositorio de GitHub confirmando el uso de LaTeX para la redacción del informe.}
\end{figure}

\subsubsection{Guía para la descarga del informe en PDF}

Para descargar el informe en formato PDF desde el repositorio de GitHub, se deben seguir los siguientes pasos:

\begin{enumerate}
    \item Acceder al repositorio mediante una computadora de escritorio o laptop a través del siguiente enlace: \\
    \href{https://github.com/AdrianaGut257/Proyecto1}{\textit{https://github.com/AdrianaGut257/Proyecto1}}  
    \item Ubicar el archivo denominado \texttt{informeFisica.build} y hacer clic sobre él.
    
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/latexVerification/verification2.jpg}
    \end{figure}

    \item Dentro del repositorio, localizar el archivo \texttt{main.pdf} y seleccionarlo.
    \item Finalmente, hacer clic en el botón \texttt{Download}. El archivo PDF del informe se descargará automáticamente en el dispositivo.
    
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/latexVerification/verification3.jpg}
    \end{figure}
...
\textbf{2. Capcut}
\vspace{-20pt}
\begin{center}\includegraphics[width=3cm]{images/tools/capcut.jpg}\end{center} \\ \hline
...
\textbf{3. Audacity}
\vspace{-20pt}
\begin{center}\includegraphics[width=3cm]{images/tools/audacity.png}\end{center} \\ \hline
...
\begin{center}\includegraphics[width=3cm]{images/tools/canva.png}\end{center} \\ \hline
\textbf{Descripción:} Herramienta de diseño gráfico en línea que permite crear presentaciones, infografías y materiales visuales. \\ \hline
\textbf{Uso:} Elaboración para resolucion del ejercicio \\ \hline
\textbf{Acceso en línea:} \href{https://www.canva.com/design/DAHFF0Vulto/-7hnfEWM10rVw8DgCoXpOA/edit}{\textit{Pulsa aquí}} \\
\hline
\end{tabular}
\vspace{10pt}
\caption{Tabla: Herramienta Canva}
