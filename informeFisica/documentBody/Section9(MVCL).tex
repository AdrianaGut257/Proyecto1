...
\begin{figure}[htbp]
    ...
    \caption{Movimiento de caída libre}
    \adjustbox{margin={0pt 0pt 0pt 0pt}}{
        \includegraphics[width=0.3\textwidth, trim=0 5 0 0, clip]{images/cinematicImages/freeFall.jpg}
    }
    \caption*{Nota: Movimiento vertical con aceleración constante debida a la gravedad.}
\end{figure}
