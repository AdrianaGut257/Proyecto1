...
\begin{figure}[H]
    ...
    \caption{Gráfica posición-tiempo en movimiento uniforme}
    \includegraphics[width=0.6\textwidth]{images/demonstrations/uniformMovement.jpg}
    \caption*{Nota: Relación lineal entre la posición y el tiempo, cuya pendiente representa la velocidad constante.}
\end{figure}
