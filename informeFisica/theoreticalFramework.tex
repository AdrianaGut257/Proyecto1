...
\begin{itemize}
    \item El automóvil con MRU y el camión con MRUA se encuentran en dos momentos distintos: el primero a $t \approx 2{,}3$ s en la posición $x \approx 90{,}2$ m, y el segundo a $t \approx 17{,}74$ s.
    \item Las velocidades de ambos vehículos son iguales a los $t = 10$ s, instante en el que el automóvil está 120 m adelante del camión.
    \item La aplicación de las ecuaciones integrales del MRU y MRUA permite obtener con precisión las funciones de posición y velocidad de cada cuerpo, facilitando el análisis de encuentro entre móviles.
    \item La simulación en GeoGebra confirma visualmente los resultados algebraicos, permitiendo una mejor comprensión del comportamiento dinámico de los dos vehículos.
\end{itemize}

\section{Recomendaciones}

\begin{itemize}
    \item Se recomienda convertir siempre las unidades al Sistema Internacional (m, s) antes de plantear las ecuaciones, para evitar errores de cálculo.
    \item Es conveniente establecer claramente el sistema de referencia y la posición inicial de cada cuerpo al inicio del problema.
    \item Al usar GeoGebra, es útil activar la vista gráfica y la hoja de cálculo simultáneamente para relacionar los valores numéricos con la representación visual.
    \item Para problemas con dos móviles, se recomienda graficar ambas funciones de posición en el mismo sistema de ejes y verificar visualmente los puntos de encuentro antes de resolver algebraicamente.
\end{itemize}